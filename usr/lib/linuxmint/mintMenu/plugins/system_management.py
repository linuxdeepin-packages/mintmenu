...
class pluginclass( object ):
    ...
    def do_standard_items( self ):
        ...
        if ( self.showPackageManager == True ):
            Button2 = easyButton( "/usr/share/deepin-software-center/icons/icon/icon.ico", self.iconsize, [_("Package Manager")], -1, -1 )
            Button2.connect( "clicked", self.ButtonClicked, "deepin-software-center" )
            Button2.show()
